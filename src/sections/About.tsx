    ...
    <div>
      ...
      >
        ...
        <div className="text-[var(--secondary)] lg:text-xl text-lg text-justify p-2 leading-8 font-normal">
          ...
          interests lie in full-stack web and mobile application development, as
          well as UI/UX design, where I focus on creating seamless, efficient,
          and user-friendly digital experiences. I thrive on solving complex
          problems, optimizing performance, and developing innovative solutions
          that make an impact. Eager to expand my skills and contribute to
          meaningful projects, I am constantly exploring new technologies and
